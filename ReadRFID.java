...
public class ReadRFID {
  public static void main(String[] args) throws InterruptedException {
    ...
    // System.out.println("Card Read UID:" + tagid[0] + "," + tagid[1] + "," + tagid[2] + "," +
    // tagid[3]);
    System.out.println(
        "Card Read UID:"
    ...
    // default key
    byte[] keyA =
        new byte[] {(byte) 0x03, (byte) 0x03, (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03};
    byte[] keyB =
    ...
    if (status == RaspRC522.MI_OK) System.out.println("Write data finished");
    else {
  ...
  public static boolean writeToRFID(int channel, byte fullAddress, byte data) {
    ...
    if (Spi.wiringPiSPIDataRW(channel, packet, 1) >= 0) return true;
    else return false;
  }
